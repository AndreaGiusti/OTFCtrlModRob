...
% A vector 1x3 B vector 3x1
if max([size(A_Inf,2),size(A_Sup,2)]) == 3 && max([size(B_Inf,1),size(B_Sup,1)]) == 3 && size(A_Inf,1) == 1 && size(B_Sup,1) == 3
    Ax_Inf = A_Inf(1,1);
    Ay_Inf = A_Inf(1,2);
    Az_Inf = A_Inf(1,3);
    Ax_Sup = A_Sup(1,1);
    ...
    %    -p1-    -p2-    -p3-
    %         -s1-
    [p1_Inf, p1_Sup] = prod_Int(Ax_Inf,Ax_Sup,Bx_Inf,Bx_Sup);
    [p2_Inf, p2_Sup] = prod_Int(Ay_Inf,Ay_Sup,By_Inf,By_Sup);
    [p3_Inf, p3_Sup] = prod_Int(Az_Inf,Az_Sup,Bz_Inf,Bz_Sup);
    [s1_Inf, s1_Sup] = sum_Int(p1_Inf,p1_Sup,p2_Inf,p2_Sup);
    [C_Inf,C_Sup]    = sum_Int(s1_Inf,s1_Sup,p3_Inf,p3_Sup);
end
